...
import { RenderMode } from '../Utils/segmentation/core/types';

// â”€â”€ Volume sizes used in benchmarks â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

const SIZES = {
  small:  { w: 64,  h: 64,  d: 20,  label: '64Ã—64Ã—20' },
  medium: { w: 256, h: 256, d: 50,  label: '256Ã—256Ã—50' },
  large:  { w: 512, h: 512, d: 100, label: '512Ã—512Ã—100' },
};
...
describe('Voxel access - 512Ã—512Ã—100', () => {
...
describe('getSliceImageData - 512Ã—512Ã—100', () => {
  const vol = new MaskVolume(512, 512, 100);
...
describe('getSliceImageData - render modes (512Ã—512, Z-axis)', () => {
...
describe('setSliceFromImageData - 512Ã—512', () => {
  const vol = new MaskVolume(512, 512, 100);
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
//  Memory Usage Comparison (test, not bench â€” captures metrics)
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

describe('Memory usage comparison', () => {
  bench('MaskVolume 512Ã—512Ã—100 memory', () => {
    const vol = new MaskVolume(512, 512, 100);
    void vol.getMemoryUsage(); // 26,214,400 bytes (~25 MB)
  });

  bench('ImageData 512Ã—512Ã—100 slices (Z only) memory', () => {
    // Z-axis: 100 slices Ã— 512Ã—512Ã—4 = 104,857,600 bytes (~100 MB)
    let totalBytes = 0;
    for (let z = 0; z < 100; z++) {
  ...
  bench('ImageData 512Ã—512Ã—100 slices (all axes) memory', () => {
    // Z: 100 slices Ã— 512Ã—512Ã—4
    // Y: 512 slices Ã— 512Ã—100Ã—4
    // X: 512 slices Ã— 512Ã—100Ã—4
    let totalBytes = 0;
